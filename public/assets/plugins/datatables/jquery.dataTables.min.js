...
(function (Fa, T, k) {
    var S = function (g) {
        ...
        function na(a, b, c, e) {
            var d = [], f = b.firstChild, h, i, j = 0, n, l = a.aoColumns, r = a._rowReadObject, e = e !== k ? e : r ? {} : [], q = function (a, b) {
                if ("string" === typeof a) {
                    var c = a.indexOf("@");
        ...
        function kb(a) {
            var b, c, e, d, f, h = a.nTHead, i = a.nTFoot, j = 0 === g("th, td", h).length, n = a.oClasses, l = a.aoColumns;
            j && (d = g("<tr/>").appendTo(h));
            b = 0;
        ...
        function M(a) {
            ...
            if (-1 !== g.inArray(!1, b))C(a, !1); else {
                var b = [], c = 0, e = a.asStripeClasses, d = e.length, f = a.oLanguage, h = a.iInitDisplayStart, i = "ssp" == z(a), j = a.aiDisplay;
                a.bDrawing = !0;
        ...
        function ub(a) {
            var b = a.aoColumns, c = b.length, e = a.oFeatures, d = a.oPreviousSearch, f = a.aoPreSearchCols, h, i = [], j, n, l, r = V(a);
            h = a._iDisplayStart;
        ...
        function pb(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage,
                d = a.oPreviousSearch, f = a.aanFeatures, h = '<input type="search" class="' + b.sFilterInput + '"/>', i = e.sSearch, i = i.match(/_INPUT_/) ? i.replace("_INPUT_", h) : i + h, b = g("<div/>", {
                ...
                }, h = null !== a.searchDelay ? a.searchDelay : "ssp" === z(a) ? 400 : 0, j = g("input", b).val(d.sSearch).attr("placeholder",
        ...
        function Ha(a) {
            var b = a.nTable, c = a.aoColumns, e = a.oScroll, d = e.sY, f = e.sX, h = e.sXInner, i = c.length, j = $(a, "bVisible"), n = g("th", a.nTHead), l = b.getAttribute("width"), k = b.parentNode, q = !1, m, o, p;
            p = a.oBrowser;
            e = p.bScrollOversize;
        ...
        m = function (a) {
            ...
            this.fnAddData = function (a, b) {
                var c = this.api(!0), e = g.isArray(a) && (g.isArray(a[0]) || g.isPlainObject(a[0])) ? c.rows.add(a) : c.row.add(a);
                (b === k || b) && c.draw();
            ...
            this.each(function () {
                var d = {}, d = 1 < e ? Mb(d, a, !0) : a, h = 0, i, j = this.getAttribute("id"), n = !1, l = m.defaults, r = g(this);
        ...
        p("cells()", function (a, b, c) {
            ...
            if (null === b || b === k)return this.iterator("table", function (b) {
                var e = a, d = ab(c), f = b.aoData, h = Da(b, d), i = Tb(ia(f, h, "anCells")), j = g([].concat.apply([], i)), l, n = b.aoColumns.length, m, p, t, s, u, v;
        ...
        m.isDataTable = m.fnIsDataTable = function (a) {
            ...
            g.each(m.settings, function (a, d) {
                var f = d.nScrollHead ? g("table", d.nScrollHead)[0] : null, h = d.nScrollFoot ? g("table", d.nScrollFoot)[0] : null;
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                oPaginate: {sFirst: "Đầu tiên", sLast: "Cuối cùng", sNext: "Sau", sPrevious: "Trước"},
                sEmptyTable: "Không có dữ liệu",
                sInfo: "Hiện từ _START_ đến _END_ trong tổng _TOTAL_ dòng",
                sInfoEmpty: "Hiện từ 0 đến 0 của 0 dòng",
